...
#ifndef HAKO_GFX_OPENGL_EXTENSIONS_WIN32_H
#define HAKO_GFX_OPENGL_EXTENSIONS_WIN32_H
...
typedef void(APIENTRY *PTR_GLDELETEPROGRAM)(GLuint);
typedef void(APIENTRY *PTR_GLDELETESHADER)(GLuint);
